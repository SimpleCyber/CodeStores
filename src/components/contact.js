...
const ContactForm = () => {
  ...
  return (
    ...
    >
      <div className="min-h-screen dark:bg-gray-900 flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        <div className=" dark:bg-gray-800 shadow-2xl rounded-2xl p-8 transform transition-all hover:scale-105">
